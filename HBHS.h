...
const std::string hb_path = "path-to/hbdataset";
const std::string hs_path = "path-to/hsdataset";
...
public:
  ...
  Higgs::predictions::Predictions pred;
  Higgs::predictions::BsmParticle& h1 = pred.addParticle(Higgs::predictions::BsmParticle("h1", Higgs::predictions::ECharge::neutral, Higgs::predictions::CP::even));
  Higgs::predictions::BsmParticle& h2 = pred.addParticle(Higgs::predictions::BsmParticle("h2", Higgs::predictions::ECharge::neutral, Higgs::predictions::CP::even));
  Higgs::predictions::BsmParticle& a1 = pred.addParticle(Higgs::predictions::BsmParticle("a1", Higgs::predictions::ECharge::neutral, Higgs::predictions::CP::odd));
  Higgs::predictions::BsmParticle& hp = pred.addParticle(Higgs::predictions::BsmParticle("hp", Higgs::predictions::ECharge::single,  Higgs::predictions::CP::undefined));

  Higgs::bounds::Bounds bounds = Higgs::Bounds(hb_path);
  Higgs::signals::Signals signals = Higgs::Signals(hs_path);
   ...
   */
//  HBHSResult check(THDM &model, Higgs::predictions::Predictions pred) const;
...
private:
   ...
   * @param model the model data
   */
//  void neutral_input(THDM &model, Higgs::predictions::Predictions pred) const;
   ...
   * @param model the model data
   */
//  void charged_input(THDM &model, Higgs::predictions::Predictions pred) const;
...
struct HBResult {
  ...
  std::array<std::string, HBHS::nHzero + HBHS::nHplus + 1> channel;
  std::array<std::string, HBHS::nHzero + HBHS::nHplus + 1> ncombined;
